...
module.exports = {
  name: "bassboost",
  description: "Añade efecto de bassboost a la cancion",
  ...
  run: async (client, message, args, { GuildDB }) => {
    ...
    if (!message.member.voice.channel)
      return client.sendTime(
        message.channel,
        "❌ | **Necesitas estar en el canal de voz para poder usar el comando!**"
      );
    if (
    ...
    if (!args[0])
      return client.sendTime(
        message.channel,
        "**Porfavor, selecciona un nivel de boosbass para la cancion. \nNiveles disponibles:** `none`, `low`, `medium`, `high`"
      );
