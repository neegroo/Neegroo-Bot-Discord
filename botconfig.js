module.exports = {
  Admins: ["388422519553654786"], // Admins of the bot, I don't know what this do. -Darren.
  ExpressServer: true, // If you wanted to make the website run or not
  DefaultPrefix: process.env.Prefix || "$", // Default prefix, Server Admins can change the prefix
  Port: 3000, //Which port website gonna be hosted
  SupportServer: "https://discord.gg/mCtTScyhFZ", // Support Server Link
  ...
  Presence: {
    ...
    name: "neegroo.es | $help", // The message shown
